...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='This table stores block instances. The type of block this is';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Recent activity block';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_block_recent_activity` VALUES (1,2,2,1458817597,2,0,NULL),(2,2,2,1458817657,2,2,'page'),(3,2,3,1458817716,2,0,NULL),(4,2,3,1458817794,2,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cache of time-sensitive flags';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_cache_flags` VALUES (1,'userpreferenceschanged','2',1460061584,'1',1460068784),(2,'accesslib/dirtycontexts','/1/6/27',1458818129,'1',1458825329),(3,'userpreferenceschanged','3',1458816850,'1',1458824050),(4,'userpreferenceschanged','4',1458816922,'1',1458824122),(5,'userpreferenceschanged','5',1458817056,'1',1458824256),(6,'accesslib/dirtycontexts','/1/6/27/36',1458817657,'1',1458824857),(7,'accesslib/dirtycontexts','/1/8/22',1458817860,'1',1458825060),(8,'accesslib/dirtycontexts','/1/8/23',1458817871,'1',1458825071),(9,'accesslib/dirtycontexts','/1/8/25',1458817892,'1',1458825092),(10,'accesslib/dirtycontexts','/1/8/24',1458818255,'1',1458825455),(11,'accesslib/dirtycontexts','/1/18',1458818593,'1',1458825793),(12,'accesslib/dirtycontexts','/1/8/38',1460061354,'1',1460068554),(13,'userpreferenceschanged','6',1460059581,'1',1460066781),(14,'accesslib/dirtycontexts','/1/8/21',1460061346,'1',1460068546);
...
) ENGINE=InnoDB AUTO_INCREMENT=476 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Moodle configuration variables';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=962 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Changes done in server configuration through admin UI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1128 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Moodle modules and plugins configuration variables';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='one of these must be set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_course_modules` VALUES (1,2,9,1,1,NULL,1458817079,0,0,1,1,0,0,0,NULL,0,0,0,NULL),(3,2,15,2,1,'',1458817716,0,0,1,1,0,0,0,NULL,0,0,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Draft text that is auto-saved every 5 seconds while an edito';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_editor_atto_autosave` VALUES (15,'id_introeditor',37,'6971a15c4b0af2785357235691099d683f9ee453',2,'This page contains information on Pearson preset testlogins.<br>',NULL,'yui_3_17_2_1_1458817731510_305',1458817794),(16,'id_page',37,'ca5cf089b7b1257a7703e190aaae8ebaea562db3',2,'<p></p><h4><b>Available users in this course:</b></h4><p><b>Manager/Admin:</b><br></p><p>Username: padmin<br>Password:&nbsp; moodle1$pa</p><b>Teacher</b>:<br>Username: pteacher<br>Password:&nbsp; moodle1$pt<p><b>Student:</b><br>Username: pstudent<br>Password: Moodle1$ps</p><br><p></p>',NULL,'yui_3_17_2_1_1458817731510_572',1458817794),(18,'summary',1,'4bf21a8a4b0426fdeb1f62b11fbac33b4e7f30d6',2,'',-1,'yui_3_17_2_1_1458818498010_168',1458818499),(22,'id_s_theme_clean_footnote',1,'e50040aeed5e76dbb857eeebb83dd7107821b570',2,'',-1,'yui_3_17_2_1_1460061100026_171',1460061105),(24,'summary',1,'1913a3e7ce5d780bf3634fa126e139aadc9c5290',2,'',-1,'yui_3_17_2_1_1460063462875_168',1460063463);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='built in and custom external services';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='lists functions available in each service group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_external_tokens` VALUES (2,'3a765a42a71def876c817ff2fed9d176',0,3,2,NULL,1,2,NULL,0,1459940387,1460060319);
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Standard log table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Database based session storage - now recommended';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_sessions` VALUES (28,0,'e98e0c9c51808520fd4449e305efc59f',0,NULL,1460063760,1460063765,'172.18.0.1','172.18.0.1');
...
INSERT INTO `mdl_task_scheduled` VALUES (1,'moodle','\\core\\task\\session_cleanup_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(2,'moodle','\\core\\task\\delete_unconfirmed_users_task',0,1458817200,0,'0','*','*','*','*',0,0,0),(3,'moodle','\\core\\task\\delete_incomplete_users_task',0,1458817500,0,'5','*','*','*','*',0,0,0),(4,'moodle','\\core\\task\\backup_cleanup_task',0,1458817800,0,'10','*','*','*','*',0,0,0),(5,'moodle','\\core\\task\\tag_cron_task',0,1458814800,0,'20','*','*','*','*',0,0,0),(6,'moodle','\\core\\task\\context_cleanup_task',0,1458815100,0,'25','*','*','*','*',0,0,0),(7,'moodle','\\core\\task\\cache_cleanup_task',0,1458815400,0,'30','*','*','*','*',0,0,0),(8,'moodle','\\core\\task\\messaging_cleanup_task',0,1458815700,0,'35','*','*','*','*',0,0,0),(9,'moodle','\\core\\task\\send_new_user_passwords_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(10,'moodle','\\core\\task\\send_failed_login_notifications_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(11,'moodle','\\core\\task\\create_contexts_task',0,1458864000,1,'0','0','*','*','*',0,0,0),(12,'moodle','\\core\\task\\legacy_plugin_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(13,'moodle','\\core\\task\\grade_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(14,'moodle','\\core\\task\\events_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(15,'moodle','\\core\\task\\completion_regular_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(16,'moodle','\\core\\task\\completion_daily_task',0,1458850500,0,'15','20','*','*','*',0,0,0),(17,'moodle','\\core\\task\\portfolio_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(18,'moodle','\\core\\task\\plagiarism_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(19,'moodle','\\core\\task\\calendar_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(20,'moodle','\\core\\task\\blog_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(21,'moodle','\\core\\task\\question_cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(22,'moodle','\\core\\task\\registration_cron_task',0,1459350060,0,'1','15','*','*','3',0,0,0),(23,'moodle','\\core\\task\\check_for_updates_task',0,1458820800,0,'0','*/2','*','*','*',0,0,0),(24,'moodle','\\core\\task\\cache_cron_task',0,1458816600,0,'50','*','*','*','*',0,0,0),(25,'moodle','\\core\\task\\automated_backup_task',0,1458816600,0,'50','*','*','*','*',0,0,0),(26,'moodle','\\core\\task\\badges_cron_task',0,1458814500,0,'*/5','*','*','*','*',0,0,0),(27,'moodle','\\core\\task\\file_temp_cleanup_task',0,1458824100,0,'55','*/6','*','*','*',0,0,0),(28,'moodle','\\core\\task\\file_trash_cleanup_task',0,1458824100,0,'55','*/6','*','*','*',0,0,0),(29,'moodle','\\core\\task\\stats_cron_task',0,1458817200,0,'0','*','*','*','*',0,0,0),(30,'moodle','\\core\\task\\password_reset_cleanup_task',0,1458820800,0,'0','*/6','*','*','*',0,0,0),(31,'mod_forum','\\mod_forum\\task\\cron_task',0,1458814380,0,'*','*','*','*','*',0,0,0),(32,'auth_cas','\\auth_cas\\task\\sync_task',0,1458864000,0,'0','0','*','*','*',0,0,1),(33,'auth_ldap','\\auth_ldap\\task\\sync_task',0,1458864000,0,'0','0','*','*','*',0,0,1),(34,'enrol_flatfile','\\enrol_flatfile\\task\\flatfile_sync_task',0,1458814500,0,'15','*','*','*','*',0,0,0),(35,'enrol_imsenterprise','\\enrol_imsenterprise\\task\\cron_task',0,1458817800,0,'10','*','*','*','*',0,0,0),(36,'editor_atto','\\editor_atto\\task\\autosave_cleanup_task',0,1458828960,0,'16','14','*','*','0',0,0,0),(37,'tool_langimport','\\tool_langimport\\task\\update_langpacks_task',0,1458878520,0,'2','4','*','*','*',0,0,0),(38,'tool_messageinbound','\\tool_messageinbound\\task\\pickup_task',0,1458814440,0,'*','*','*','*','*',0,0,0),(39,'tool_messageinbound','\\tool_messageinbound\\task\\cleanup_task',0,1458870900,0,'55','1','*','*','*',0,0,0),(40,'tool_monitor','\\tool_monitor\\task\\clean_events',0,1458814440,0,'*','*','*','*','*',0,0,0),(41,'logstore_legacy','\\logstore_legacy\\task\\cleanup_task',0,1458882240,0,'4','5','*','*','*',0,0,0),(42,'logstore_standard','\\logstore_standard\\task\\cleanup_task',0,1458878640,0,'4','4','*','*','*',0,0,0);
...
INSERT INTO `mdl_user_lastaccess` VALUES (1,2,2,1460061589),(2,3,2,1459966160);
...
-- Dump completed on 2016-04-07 21:16:51
