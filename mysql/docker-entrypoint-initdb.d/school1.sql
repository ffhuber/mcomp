...
) ENGINE=InnoDB AUTO_INCREMENT=934 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Changes done in server configuration through admin UI';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_external_services` VALUES (1,'Moodle mobile web service',0,NULL,0,'moodle',1458814350,1458815722,'moodle_mobile_app',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Standard log table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Database based session storage - now recommended';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mdl_sessions` VALUES (15,0,'bb5c6ea950c9cff0dd7236724a8bbbfb',0,NULL,1458819132,1458819158,'172.19.0.1','172.19.0.1');
...
INSERT INTO `mdl_user` VALUES (1,'manual',1,0,0,0,1,'guest','$2y$10$dVudXl5S09FVzs1ra79ogupe2plhtOphufXGZS/H7yVVeDIGgLbxC','','Guest user',' ','root@localhost',0,'','','','','','','','','','','','','en','gregorian','','99',0,0,0,0,'','',0,'','This user is a special user that allows read-only access to some courses.',1,1,0,2,1,0,0,1458814341,0,NULL,NULL,NULL,NULL,NULL),(2,'manual',1,0,0,0,1,'admin','$2y$10$wSLph7hAWymPHwcidWrx/uGoIX1xE5EgVG0SUmV0WGAIua2RElQxq','','Admin Moodle','Pearson','franz.huber.nospam@pearson.com',0,'','','','','','','','','','','Vienna','AT','en','gregorian','','99',1458815570,1458819125,1458818891,1458818967,'172.19.0.1','',0,'','',1,1,0,1,1,0,0,1458815714,0,NULL,'','','',''),(3,'manual',1,0,0,0,1,'padmin','$2y$10$hm8vay4kfzm2dctMFLlb0.iRuZKIgzYmEORisKtusVQy5A9wKD7cK','','Admin','Pearson','pa@pearson.com',0,'','','','','','','','','','','','','en','gregorian','','99',0,0,0,0,'','',0,'','',1,1,0,0,1,0,1458816850,1458816850,0,'','','','',''),(4,'manual',1,0,0,0,1,'pstudent','$2y$10$3EH0shit6KdSFt.ySQiIrOCS1Gx/9/XF7JRZLTf1AwRJK.lVaJvcK','','Student','Person','ps@pearson.com',0,'','','','','','','','','','','','','en','gregorian','','99',0,0,0,0,'','',0,'','',1,1,0,0,1,0,1458816922,1458816922,0,'','','','',''),(5,'manual',1,0,0,0,1,'pteacher','$2y$10$jwRgUsU0jDSLGU56O3Y0aexZ/GcwNvINYedKMYY5v06tNTuTRUCaC','','Teacher','Pearson','pt@pearson.com',0,'','','','','','','','','','','','','en','gregorian','','99',0,0,0,0,'','',0,'','',1,1,0,0,1,0,1458817056,1458817056,0,'','','','','');
...
INSERT INTO `mdl_user_lastaccess` VALUES (1,2,2,1458818110);
...
-- Dump completed on 2016-03-24 12:42:47
